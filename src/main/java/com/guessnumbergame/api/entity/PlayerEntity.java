package com.guessnumbergame.api.entity;
 ...
 * Should be used as a JPA entity.
 * <p>
 ...
 * 
 * @see PlayerSummary, PlayerRepository
 */
@Entity
@Table(name = "PLAYER")
@DynamicUpdate
@NamedQuery(name = "find_all_player_summaries",
    query = "select new com.guessnumbergame.api.dto.PlayerSummary(id, username, bestAttemptsCount) "
        + "from PlayerEntity")
